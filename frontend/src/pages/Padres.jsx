...
function Padres() {
  ...
  const padresFiltrados = padres.filter((padre) => {
    ...
    const valor =
      `${padre.nombres} ${padre.apellidos} ${padre.dni} ${estudiante?.nombres || ""} ${estudiante?.apellidoPaterno || ""}`.toLowerCase();
  ...
  const totalConVinculo = padres.filter(
    (p) => estudiantePorPadre[p.idPadre],
  ).length;

  const totalPaginas = Math.ceil(padresFiltrados.length / ITEMS_POR_PAGINA);
          ...
          >
              ...
              <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3">
                <div className="flex-grow-1">
                  ...
                  <p className="text-white-50 small m-0 mt-2 fw-medium">
                    Administra los padres y madres de familia vinculados a los
                    estudiantes.
                  </p>
                </div>
            ...
            {!padreSeleccionado && (
              ...
              >
                ...
                >
                  <div>
                    ...
                    <p className="text-muted small mb-0">
                      {padresFiltrados.length} resultados de {padres.length}{" "}
                      registros
                    </p>
                  </div>
                ...
                <div className="padres-table-scroll">
                  <table className="table align-middle mb-0 padres-table">
                    <thead className="padres-table-head">
                      <tr>
                        <th className="ps-4 py-3 text-secondary">
                          Padre / Madre
                        </th>
                            ...
                            <td className="text-center">
                              <div className="d-flex justify-content-center gap-2 flex-wrap">
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    eliminarRegistro(padre.idPadre)
                                  }
                                >
                                  <FaTrashAlt />
                                </button>
                    ...
                    <div className="d-flex align-items-center gap-2">
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: "1px solid #e5e7eb",
                          backgroundColor:
                            paginaActual === totalPaginas ? "#f9fafb" : "#fff",
                          color:
                            paginaActual === totalPaginas
                              ? "#d1d5db"
                              : "#115133",
                  ...
                  >
                    ...
                    <div className="d-flex justify-content-center gap-2">
                      <button
                        ...
                        onClick={() =>
                          eliminarRegistro(padreSeleccionado.idPadre)
                        }
                      >
                        🗑️ Eliminar
                      </button>
                    ...
                    >
                      <div className="row">
                        ...
                        <div className="col-sm-8 fw-semibold">
                          : {padreSeleccionado.nombres}{" "}
                          {padreSeleccionado.apellidos}
                        </div>
                      </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-8 fw-semibold">
                          : {nombreEstudiante(padreSeleccionado)}
                        </div>
                      </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-8 fw-semibold">
                          : SF-P-{padreSeleccionado.idPadre}
                        </div>
                      </div>
                    </div>
                  </div>
